...
from .views import (cashier_deposits, supervisor_deposits, dashboard, reports, CreditSupervisorAccount, my_borrows,
                    ...
                    UpdateWithdrawCash, approve_withdrawal_request, my_withdrawals, disapprove_withdrawal_request, BorrowCash,
                    ...
                    UpdateBorrowCash, borrows, approve_borrow_request, disapprove_borrow_request)
...
urlpatterns = [
    ...
    path("borrow_cash", BorrowCash.as_view(), name='borrow_cash'),
